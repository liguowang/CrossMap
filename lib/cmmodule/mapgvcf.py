...
from cmmodule.utils import map_coordinates, is_dna
        ...
        # update contig information
            ...
            for chr_id in sorted(target_gsize):
                if chr_id.startswith('chr'):
                    print(
                        "##contig=<ID=%s,length=%d,assembly=%s>"
                        % (update_chromID(chr_template, chr_id, cstyle),
                           target_gsize[chr_id],
            ...
            if 'END=' in line:
                ...
                if len(a) == 2:
                    ...
                    fields[7] = fields[7].replace(
                        ('END=' + str(end)), ('END=' + str(target_end)))
            ...
            # process variant line
                ...
                # 20  10000598    .   T   A,<NON_REF> 1754.77 .   DP=54;
                alt_allele = fields[4].replace(' ', '').split(',')[0]
                ...
                if len(a) == 2:
                    ...
                    # fields correspond to the nucleotide at
                    # POS in the *reference genome*
                    ref_allele = fields[3]
                    ...
                    # update END if any
                    fields[7] = re.sub(
                        'END\=\d+', 'END='+str(target_end), fields[7])
