...
class ParseWig2:
    ...
    provie methods to manipulate wiggle format file. For wiggle format see:
    http://genome.ucsc.edu/goldenPath/help/wiggle.html.
    The same coordinate could occur more than
    one time in wig file, and the scores will be sumed up.
    Slower than ParseWig
    '''
    ...
    def distriub_wig(self, bed, till_count=100):
        '''
        calculate coverage over bed file (only consider exon regions).
        The mRNA sequences in input bed file will be cut into 100 tills
        of equal size
        '''
        ...
        for line in open(bed, 'r'):
            try:
                ...
                print(
                    "[input bed must be 12-column] skipped this line: "
